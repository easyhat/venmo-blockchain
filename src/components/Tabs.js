...
const Tabs = () => {
  ...
  return (
    <div>
      <div className='sm:hidden relative w-1/2 mx-auto bg-black rounded'>
        ...
        >
          <option className='text-sm text-gray-600'>Transactions </option>
          <option className='text-sm text-gray-600'>Send & Receive </option>
        </select>
      </div>
        ...
        <ul className='flex border-b px-5'>
          ...
          >
            <div className='flex items-center mb-3'>
              ...
              <span className='ml-1 font-normal'>
                {activeStatus == 1 ? 'Active' : 'Transactions'}
              </span>
            </div>
            {activeStatus == 1 && (
          ...
          >
            <div className='flex items-center mb-3'>
              ...
              <span className='ml-1 font-normal'>
                {activeStatus == 2 ? 'Active' : 'Send & Receive'}
              </span>
            </div>
            {activeStatus == 2 && (
              <div className='w-full h-1 bg-indigo-700 rounded-t-md'>
